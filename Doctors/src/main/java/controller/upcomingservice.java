...
/**
 * Servlet implementation class upcomingservice
 */
@WebServlet("/upcomingservice")
public class upcomingservice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(doctorid != 0) {
    		bookingInfo = new DatLichHandler().UpcomingService_BS(doctorid);
    	}else if(patientid != 0) {
    		bookingInfo = new DatLichHandler().UpcomingService_BN(patientid);
    	}
	...
	private class Data {
		...
		ArrayList<ServiceInfo> bookingInfo = new ArrayList<ServiceInfo>();
		public Data(ArrayList<TimeAndID> dateCards, ArrayList<ServiceInfo> bookingInfo) {
			super();
