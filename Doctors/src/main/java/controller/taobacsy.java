...
/**
 * Servlet implementation class taobacsy
 */
@WebServlet("/taobacsy")
public class taobacsy extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				String matkhau_confirm = request.getParameter("matkhau-confirm-dangky");
				...
				if(!matkhau_confirm.equals(matkhau)) {
