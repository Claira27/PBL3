    ...
    <div class="app">
        ...
        <div class="grid">
            <div class="change-info">
                <!-- Sign-in form -->
                <form action="doimatkhaunguoidung" id="form-4" method="POST">
            ...
            <div class="menu-wrap">
                ...
                <div class="menu-list">
                    ...
                    <div class="menu-item on-task">Đặt Lại Mật Khẩu</div>
        ...
        Validator({
            ...
            rules: [
                ...
                Validator.isConfirmed('#matkhau-confirm-dangky',function(){
                  return document.querySelector('#form-4 #matkhau-dangky').value;
