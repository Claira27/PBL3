...
<body>
                ...
                <div class="content-admin">
                    <div class="navbar">
                        <div class="nav-group">
                            ...
                            <a href="admin2_create.jsp" class="add">+</a>
                            <div class="search">
                                <input type="text" class="search-key" placeholder="Nhập tên bác sỹ vào đây">
                    ...
                    <div class="content-title">Bác Sỹ</div>
                    <div class="group3">
                        <div class="group3-item-2">
                            <div class="g3-title">Bác Sỹ Phổ Biến</div>
                            <div class="g3-header">
                                <p class="g3 s1">#</p>
                                <p class="g3 s2">Bác Sỹ</p>
                                <p class="g3 s3">Bệnh Viện</p>
                                <p class="g3 s4">Lượt Đặt</p>
                                <p class="g3 s5">Đánh Giá</p>
                                <p class="g3 s6">Sửa</p>
                            </div>
                            <div class="g3-body">
    ...
    <script src="assets/js/adminbacsy.js"></script>
    <%} %>
</body>
</html>