...
<head>
    ...
    <link rel="stylesheet" href="assets/css/bs_thongke.css">
...
<body>
		...
		<div class="container result-background">
            <div class="grid">
                <div class="main">
                    <div class="task-wrap">
                    	<div>
                    		<span class="bar-title">Số lượt đặt trước trong năm</span>
                    		<div class="bar-msg">Đánh giá hiện tại: <span id="start-result" class="rating-msg"></span> (trên <span id="ratings"></span> lượt)</div>
                    	</div>
                    ...
                    <div class="menu-wrap">
                        ...
                        <div class="menu-list">
		                  ...
		                  <span class="menu-item on-task">Xem Thống kê</span>
    ...
    <script src="assets/js/bacsythongke.js"></script>
    <%} %>
</body>
</html>